...
void Register()
{
    ...
    ofstream fout;
    string str;
    fin.open("D:\\Crypto\\text.txt");
    fout.open("D:\\Crypto\\register.txt");
    if (!fin.is_open())
    {
...
void DeleteSymbols()
{
    ifstream fin;
    ofstream fout;
    fin.open("D:\\Crypto\\register.txt");
    fout.open("D:\\Crypto\\space.txt");
    if (!fin.is_open())
    {
        cout << "Ошибка открытия файла!\n";
    }
...
void Space()
{
    ifstream fin;
    ofstream fout;
    fin.open("D:\\Crypto\\space.txt");
    fout.open("D:\\Crypto\\space1.txt");
    if (!fin.is_open())
    {
        cout << "Ошибка открытия файла!\n";
    }
...
void NotSpace()
{
    ifstream fin;
    ofstream fout;
    fin.open("D:\\Crypto\\space1.txt");
    fout.open("D:\\Crypto\\Notspace.txt");
    if (!fin.is_open())
    {
        cout << "Ошибка открытия файла!\n";
    }
...
void FrequencyLettersNotSpace()
{
    ...
    const char alph[] = { 'а', 'б','в', 'г', 'д', 'е', 'ж', 'з', 'и', 'й', 'к',
                          ...
                          'ц','ч', 'ш', 'щ', 'ы', 'ь', 'э', 'ю', 'я'};
    ifstream fin;
    fin.open("D:\\Crypto\\Notspace.txt");
    if (!fin.is_open())
    {
        cout << "Ошибка открытия файла!\n";
    }
...
void BigramSpace()
{
    ...
    FILE* plain;
    ofstream fout;
    fout.open("D:\\Crypto\\bigramspace.txt");
    fopen_s(&plain, "D:\\Crypto\\space1.txt", "r");
...
void BigramNotSpace()
{
    ...
    FILE* plain;
    ofstream fout;
    fout.open("D:\\Crypto\\bigramnotspace.txt");
    fopen_s(&plain, "D:\\Crypto\\Notspace.txt", "r");
    memset(count, 0, sizeof(count));
